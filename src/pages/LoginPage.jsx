...
const LoginPage = () => {
    ...
    return (
        <div className="max-w-md mx-auto mt-10 bg-white p-8 rounded-xl shadow-lg border border-gray-100">
            <SEO title="Login" />
            <h2 className="text-2xl font-bold text-center text-nature-green mb-6">Welcome Back</h2>
            ...
            <p className="mt-4 text-center text-sm text-gray-600">
                Don't have an account? <Link to="/register" className="text-nature-green font-bold">Register</Link>
            </p>
        </div>
    );
};
